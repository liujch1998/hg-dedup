...
poormanray create --name ${NAME} --number 22 --instance-type i7i.48xlarge --detach --ami-id ami-084568db4383264d4 --storage-size 32 # ubuntu
sleep 60
poormanray setup --name ${NAME} # setup AWS credentials
poormanray map --name ${NAME} --script alldressed --spindown
